...
// since we are creating two servers now http and https but the functions logic which is common between both why to write 
// it 2 times it's better to expliclitly make function and pass in both the servers
